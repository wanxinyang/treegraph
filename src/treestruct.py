...
def main(wood, slice_interval, min_pts):

    wood_down, wood_nbrs = tls.utility.downsample_cloud(wood, 0.1,
                                                        return_neighbors=True)
    skeleton_downsample, skeleton_path_dist = wood_skeleton(wood_down, 0.2,
                                                            0.03, 0.2,
                                                            return_dist=True)
